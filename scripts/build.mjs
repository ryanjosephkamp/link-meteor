...
for (const file of ['background.js','content/capture.js','core/model.js','core/export.js','ui/workbench.html','ui/workbench.js',...Object.values(manifest.icons)]) await stat(resolve(source,file));
