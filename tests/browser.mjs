...
try {
  ...
  await ui.locator('#dedupe').selectOption('url');assert.equal(await ui.locator('.link-row').count(),1);assert.match(await ui.locator('.row-details summary').innerText(),/2 source occurrences/);
